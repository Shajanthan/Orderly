...
export default function SplashScreen({ onFinish }: SplashScreenProps) {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-screen bg-gradient-to-br from-slate-600 via-slate-700 to-slate-800 overflow-hidden">
        ...
        <div className="relative mb-8">
          <div className="slow-bounce">
            <div className="bg-white rounded-full p-6 shadow-2xl">
              <SiCodechef size={64} className="text-slate-900" />
            </div>
          </div>
        </div>
